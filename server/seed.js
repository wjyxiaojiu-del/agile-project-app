...
async function seed() {
  ...
  // Create user stories
  const stories = [
    ['US-001', 1, '入学材料清单梳理', '一次性梳理出完整的入学所需材料清单', 'P0', 3, 1, 'todo', '清单包含证件类、档案类、照片类、费用类、其他特殊要求'],
    ['US-002', 1, '证件材料准备', '提前准备好身份证、录取通知书、户口迁移证等核心证件', 'P0', 5, 1, 'todo', '所有Must Have材料已备齐并拍照留底'],
    ['US-003', 1, '录取后续手续办理', '完成政审、档案邮寄、党团关系转接等后续手续', 'P0', 5, 1, 'todo', '政审表已盖章、档案已邮寄、党团关系已转出'],
    ['US-004', 1, '导师首次沟通', '在入学前与导师进行首次正式沟通', 'P0', 3, 2, 'todo', '产出沟通纪要，包含研究方向、推荐书目、入学准备建议'],
    ['US-005', 1, '研究方向初步确认', '与导师讨论后初步确定研究方向', 'P0', 5, 2, 'todo', '产出1份研究方向初步规划文档，导师已确认'],
    ['US-006', 1, '住宿与生活准备', '提前了解学校住宿条件并做好生活准备', 'P0', 3, 1, 'todo', '住宿确认完成，生活用品清单已备齐'],
    ['US-007', 1, '核心文献阅读（第1本）', '阅读导师推荐的第1本核心文献', 'P1', 8, 2, 'todo', '产出1份读书笔记（≥2000字）'],
    ['US-008', 1, '核心文献阅读（第2本）', '阅读第2本核心文献', 'P1', 8, 3, 'todo', '产出1份读书笔记（≥2000字），包含与第1本的对比分析'],
    ['US-009', 1, '核心文献阅读（第3本）', '阅读第3本核心文献', 'P1', 8, 3, 'todo', '产出1份读书笔记（≥2000字），包含三本书的整体知识图谱'],
    ['US-010', 1, '学习文献管理工具', '学会使用Zotero或EndNote进行文献管理', 'P1', 5, 2, 'todo', '成功导入10篇文献，建立分类文件夹，完成1次引用插入'],
    ['US-011', 1, '学习笔记工具', '学会使用Obsidian或Notion搭建个人知识库', 'P1', 5, 2, 'todo', '建立至少3个分类模块，录入10+条笔记，设置好模板'],
    ['US-012', 1, '学术写作工具', '学会使用LaTeX或Word高级排版', 'P1', 5, 3, 'todo', '产出1份格式规范的模板文档'],
    ['US-013', 1, '数据处理工具', '学会使用Python/SPSS进行基础数据处理', 'P1', 5, 3, 'todo', '完成1个小型数据集的清洗、分析、可视化全流程'],
    ['US-014', 1, '学习文献检索方法', '掌握CNKI、Web of Science等数据库的高级检索技巧', 'P1', 3, 2, 'todo', '建立1个包含20+篇相关文献的检索结果集'],
    ['US-015', 1, '学术社交网络搭建', '关注研究领域内的核心学者和团队', 'P2', 3, 4, 'todo', '关注至少10位核心学者，订阅3个相关期刊'],
    ['US-016', 1, '跨专业课程了解', '了解培养方案中的课程设置', 'P2', 3, 3, 'todo', '产出1份课程规划表'],
    ['US-017', 1, '同届同学社群融入', '加入同届研究生的交流群组', 'P2', 2, 1, 'todo', '加入至少2个群组，认识至少5位同届同学'],
    ['US-018', 1, '个人简历与学术主页优化', '更新个人简历并考虑建立学术主页', 'P2', 3, 4, 'todo', '简历已更新至最新状态'],
  ];
