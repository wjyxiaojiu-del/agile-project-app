...
import { Plus, Edit2, Trash2, Shield, AlertCircle, CheckSquare, Square, Trash } from 'lucide-react';
...
function RiskForm({ risk, onSave, onCancel }) {
  ...
  const handleSubmit = () => { if (validate()) onSave({ ...form, level: autoLevel(form.probability, form.impact) }); };
