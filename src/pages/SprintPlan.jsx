...
import { Zap, ChevronRight, Edit3, Check, X, Pencil, Plus, Trash2, Calendar } from 'lucide-react';
            ...
            <div className="grid grid-cols-3 gap-3">
              {['S', 'A', 'B'].map((p, i) => {
                ...
                const gradients = {
                  ...
                  A: 'linear-gradient(135deg, rgba(249,115,22,0.06), rgba(249,115,22,0.1))',
    ...
    <Modal open={open} onClose={onClose} title="新建迭代">
      <div className="space-y-4">
        ...
        <div className="flex justify-end gap-2 pt-3" style={{ borderTop: '1px solid rgba(241,245,249,0.5)' }}>
          ...
          <button onClick={handleSubmit} className="btn btn-primary">创建</button>
        </div>
      </div>
    </Modal>
  );
