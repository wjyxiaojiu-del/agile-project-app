...
import { Send, Sparkles, FileText, ListTodo, BarChart3, BookOpen, Loader2, User, Bot, Copy, Check, Trash2 } from 'lucide-react';
...
const QUICK_ACTIONS = [
  ...
  { id: 'breakdown', icon: ListTodo, label: '任务拆解', color: '#ea580c' },
    ...
    <div className="flex flex-col h-[calc(100vh-3rem)] max-w-[1400px]">
      ...
      <div className="flex gap-4 flex-1 min-h-0">
        ...
        <div className="flex-1 flex flex-col card overflow-hidden">
              ...
              <div key={msg.id} className={`flex gap-3 ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}
                ...
                <div className={`max-w-[70%] rounded-2xl px-4 py-3 ${
                  ...
                  {msg.role === 'assistant' && !msg.error && (
                    <div className="flex items-center gap-1 mt-2 pt-2" style={{ borderTop: '1px solid rgba(0,0,0,0.05)' }}>
                      <button
          ...
          {activeAction && (
            <div className="px-5 py-2 border-t" style={{ background: 'rgba(234,88,12,0.03)', borderColor: 'rgba(241,245,249,0.6)' }}>
