...
import { Plus, Search, BookOpen, Star, Trash2, Edit2, ExternalLink, Tag, Filter, X, Eye, EyeOff, FileText } from 'lucide-react';
        ...
        {Object.entries(STATUS_MAP).map(([key, val]) => {
          ...
          return (
            <button
              ...
              style={{ background: filterStatus === key ? 'rgba(234,88,12,0.08)' : 'rgba(255,255,255,0.6)' }}>
