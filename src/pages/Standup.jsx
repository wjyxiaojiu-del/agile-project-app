...
import { Plus, Calendar, Trash2, Edit2, Sun, Coffee, CloudRain, AlertCircle, Zap, CheckSquare, Square, Clock } from 'lucide-react';
    ...
    <div className="space-y-5 max-w-[1400px]">
      ...
      <div className="card-glass p-5" style={{ animation: 'slideUp .5s var(--spring-bounce) .05s both' }}>
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="rounded-xl p-3.5" style={{ background: 'rgba(234,88,12,0.04)' }}>
